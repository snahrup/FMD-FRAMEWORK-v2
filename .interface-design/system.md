...
- [2026-04-26] The dashboard must present as one FMD operating product; Dagster/runtime/engine-choice language is implementation detail and should not appear in primary user-facing workflows.
