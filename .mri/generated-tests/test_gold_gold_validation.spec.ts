 ...
 *
 * KPIs detected: internal, ml-1.5, rounded-md px-4 py-2 text-sm font-medium hover:opacity-90, rounded-md border px-3 py-1.5 text-sm, openSpec(s)}>, openCat(c)}>, openReport(r)}>, Active Waiver
 * Status filters: All
 * Modals: 3
 * Table columns: Spec Name, Status, Version, Domain, Display Name, Technical Name, Owner, Sensitivity
 *
