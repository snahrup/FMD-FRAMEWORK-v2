 ...
 *
 * KPIs detected: py-4, pb-2, pt-0, flex items-center gap-2, pt-0 space-y-3, py-3 px-4, Source System Breakdown, Source
 * Status filters: all
 * Has search: yes
 * Table columns: ID, Entity, Schema, Source, LZ, Bronze, Silver
 *
