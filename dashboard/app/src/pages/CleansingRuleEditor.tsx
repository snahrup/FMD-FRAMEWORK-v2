    ...
    <div className="space-y-6 px-8 py-8 max-w-[1280px] mx-auto">
      <div>
        <div className="flex items-center gap-2">
          ...
          <h1 style={{ fontFamily: "var(--bp-font-display)", fontSize: 32, color: "var(--bp-ink-primary)" }} className="font-semibold tracking-tight">Cleansing Rule Editor</h1>
          <span
        ...
        <p className="text-sm mt-1" style={{ color: "var(--bp-ink-secondary)" }}>
          Manage JSON cleansing rules applied during Bronze &rarr; Silver transformation
        </p>
      </div>
