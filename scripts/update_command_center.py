...
PAGES = [
    ...
    {"name": "Error Intelligence", "route": "/errors", "lane": "Audit", "packets": [],
     "focus": "Users diagnose failures here", "next": "Audit"},
    {"name": "Execution Log", "route": "/logs", "lane": "Audit/UI", "packets": ["UP-01", "UP-06"],
     "focus": "Truth first, then token cleanup", "next": "Audit then UP-01/06"},
    ...
    {"name": "Data Catalog", "route": "/catalog", "lane": "Audit", "packets": [],
     "focus": "Entity catalog unverified", "next": "Audit"},
    ...
    {"name": "Config Manager", "route": "/config", "lane": "Truth/UI", "packets": ["RP-11"],
     "focus": "GUIDs + cascade modal", "next": "RP-11"},
    {"name": "Engine Control", "route": "/engine", "lane": "Truth/UI", "packets": ["UP-04"],
     "focus": "Ghost endpoint + critical token drift", "next": "UP-04"},
    {"name": "Portal Sources", "route": "/sources-portal", "lane": "Audit", "packets": [],
     "focus": "Truth touched, rest unaudited", "next": "Audit"},
    {"name": "Portal Catalog", "route": "/catalog-portal", "lane": "Audit", "packets": [],
     "focus": "Truth touched, rest unaudited", "next": "Audit"},
    {"name": "Business Alerts", "route": "/alerts", "lane": "Audit", "packets": [],
     "focus": "Potential same enum bug class as Overview", "next": "Audit"},
